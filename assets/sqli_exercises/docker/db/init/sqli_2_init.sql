...
CREATE DATABASE exercise_2_db;

CREATE TABLE exercise_2_db.users (
	id INT(6) AUTO_INCREMENT PRIMARY KEY,
	username VARCHAR(128) NOT NULL,
	password VARCHAR(128) NOT NULL 
);

INSERT INTO exercise_2_db.users 
	(username, password)
VALUES
	('admin', 'what_cheese_do_you_use_to_make_a_bear_come_to_you?_camembert'),
	('alice', 'alicepassword'),
	('bob', 'bobpassword');

CREATE TABLE exercise_2_db.products (
	id INT(6) NOT NULL,
...
INSERT INTO exercise_2_db.products 
...
GRANT SELECT ON exercise_2_db.* to 'user2' identified by 'password';
