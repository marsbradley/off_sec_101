...
CREATE DATABASE exercise_1_db;

CREATE TABLE exercise_1_db.users (
	id INT(6) AUTO_INCREMENT PRIMARY KEY,
	username VARCHAR(128) NOT NULL,
	password VARCHAR(128) NOT NULL 
);

INSERT INTO exercise_1_db.users 
	(username, password)
VALUES
	('admin', 'hello_is_it_brie_you_are_looking_for?'),
	('alice', 'alicepassword'),
	('bob', 'bobpassword');

CREATE TABLE exercise_1_db.products (
	id INT(6) NOT NULL,
...
INSERT INTO exercise_1_db.products 
...
GRANT SELECT ON exercise_1_db.* to 'user1' identified by 'password';
